...
{
    public class InserirContatoRepository : RepositoryBase, IInserirContatoRepository
    {
        public InserirContatoRepository(IDbConnection dbConnection) : base(dbConnection)
        {
        }
        ...
        {
            string query = "UPDATE contato_tb SET =Nome =@Nome, Celular =@Celular, Email =@Email" +
